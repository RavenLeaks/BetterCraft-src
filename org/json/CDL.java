...
/* 163 */           string.indexOf(false) >= 0 || string.charAt(0) == '"')) {
/* 164 */           sb.append('"');
...
/* 257 */       if (names != null) {
/* 258 */         return String.valueOf(rowToString(names)) + toString(names, ja);
/*     */       }
/*     */     } 
/* 261 */     return null;
/*     */   }
...
/* Location:              C:\Users\emlin\Desktop\BetterCraft.jar!\org\json\CDL.class
