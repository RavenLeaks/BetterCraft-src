...
/*  54 */       if (c < ' ' || c == '+' || c == '%' || c == '=' || c == ';') {
/*  55 */         sb.append('%');
/*  56 */         sb.append(Character.forDigit((char)(c >>> 4 & 0xF), 16));
...
/*  89 */     x.next();
/*  90 */     while (x.more()) {
/*  91 */       Object value; String name = unescape(x.nextTo("=;"));
/*  92 */       if (x.next() != '=') {
...
/* Location:              C:\Users\emlin\Desktop\BetterCraft.jar!\org\json\Cookie.class
