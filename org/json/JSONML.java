...
/*     */             }
/* 175 */             newjo.accumulate(attribute, keepStrings ? token : XML.stringToValue((String)token));
...
/* 444 */         i++;
/* 445 */         if (object == null)
/* 446 */           continue;  if (object instanceof String) {
...
/* Location:              C:\Users\emlin\Desktop\BetterCraft.jar!\org\json\JSONML.class
