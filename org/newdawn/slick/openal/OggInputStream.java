...
/*     */ 
/*     */                 
/* 340 */                 if ((samples = this.dspState.synthesis_pcmout(_pcm, 
/* 341 */                     _index)) <= 0)
/* 342 */                   continue label87;  float[][] pcm = _pcm[0];
/*     */                 
/* 344 */                 int bout = (samples < this.convsize) ? samples : 
/* 345 */                   this.convsize;
/*     */ 
/*     */ 
/*     */                 
...
/* 408 */               Exception exception1; Log.error("Failure during vorbis decoding");
/* 409 */               Log.error(exception1);
