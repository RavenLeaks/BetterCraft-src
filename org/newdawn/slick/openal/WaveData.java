...
/*  97 */             new BufferedInputStream(path.openStream())));
...
/* 142 */             new BufferedInputStream(new ByteArrayInputStream(buffer))));
...
/*     */     
/* 207 */     byte[] buf = 
/* 208 */       new byte[audioformat.getChannels() * 
/* 209 */         (int)ais.getFrameLength() * 
/* 210 */         audioformat.getSampleSizeInBits() / 
/* 211 */         8];
/* 212 */     int read = 0, total = 0;
/*     */     try {
/* 214 */       while ((read = ais.read(buf, total, buf.length - total)) != -1 && 
...
/*     */ 
/*     */     
/* 229 */     WaveData wavedata = 
/* 230 */       new WaveData(buffer, channels, (int)audioformat.getSampleRate());
/*     */ 
/*     */     
/*     */     try {
/* 234 */       ais.close();
