...
/*     */   
/*  31 */   private Shape rect2 = (new Rectangle(310.0F, 210.0F, 50.0F, 100.0F)).transform(
/*  32 */       Transform.createRotateTransform((float)Math.toRadians(45.0D), 335.0F, 260.0F));
/*     */   
...
/*     */   
/*  40 */   private Shape circle4 = (new Ellipse(510.0F, 350.0F, 30.0F, 30.0F)).transform(
/*  41 */       Transform.createTranslateTransform(-510.0F, -350.0F)).transform(
/*  42 */       Transform.createScaleTransform(2.0F, 2.0F)).transform(
/*  43 */       Transform.createTranslateTransform(510.0F, 350.0F));
/*     */   
