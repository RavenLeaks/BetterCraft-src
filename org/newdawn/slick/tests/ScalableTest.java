...
/* 47 */     g.drawString(String.valueOf(container.getInput().getMouseX()) + "," + container.getInput().getMouseY(), 10.0F, 400.0F);
...
/* 90 */             g.drawString(String.valueOf(container.getInput().getMouseX()) + "," + container.getInput().getMouseY(), 400.0F, 20.0F);
/*    */           }
/*    */         };
/*    */ 
/*    */       
