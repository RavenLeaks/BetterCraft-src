...
/*  59 */         len = 100.0F;
/*     */       } 
/*  61 */       this.poly.addPoint((float)FastTrig.cos(Math.toRadians(x)) * len, 
/*  62 */           (float)FastTrig.sin(Math.toRadians(x)) * len);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*  74 */       g.drawLine(700.0F, 100.0F, (int)(700.0D + Math.cos(Math.toRadians(x)) * 100.0D), 
/*  75 */           (int)(100.0D + Math.sin(Math.toRadians(x)) * 100.0D));
/*     */     }
