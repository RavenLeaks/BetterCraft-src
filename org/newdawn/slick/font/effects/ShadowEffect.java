...
/* 247 */     values.add(EffectUtil.optionValue("Blur kernel size", String.valueOf(this.blurKernelSize), optionsArray, 
/* 248 */           "This setting controls how many neighboring pixels are used to blur the shadow. Set to \"None\" for no blur."));
/*     */     
/* 250 */     values.add(EffectUtil.intValue("Blur passes", this.blurPasses, 
/* 251 */           "The setting is the number of times to apply a blur to the shadow. Set to \"0\" for no blur."));
/* 252 */     return values;
/*     */   }
/*     */ 
/*     */ 
