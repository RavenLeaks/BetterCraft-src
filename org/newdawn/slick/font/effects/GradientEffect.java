...
/* 168 */     values.add(EffectUtil.intValue("Offset", this.offset, 
/* 169 */           "This setting allows you to move the gradient up or down. The gradient is normally centered on the glyph."));
