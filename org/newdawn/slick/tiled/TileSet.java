...
/*     */       try {
/*  76 */         InputStream in = ResourceLoader.getResourceAsStream(
/*  77 */             String.valueOf(map.getTilesLocation()) + "/" + source);
...
/*  85 */         Log.error(e);
/*  86 */         throw new SlickException(
/*  87 */             "Unable to load or parse sourced tileset: " + 
/*  88 */             this.map.tilesLocation + "/" + source);
/*     */       } 
/*     */     }
...
/*  94 */       throw new SlickException(
/*  95 */           "TiledMap requires that the map be created with tilesets that use a single image.  Check the WiKi for more complete information.");
/*     */     }
/*     */     
...
/*     */     
/* 123 */     if (loadImage) {
/* 124 */       Image image = new Image(String.valueOf(map.getTilesLocation()) + "/" + ref, false, 
/* 125 */           2, trans);
...
/* 196 */     this.tiles = new SpriteSheet(image, this.tileWidth, this.tileHeight, this.tileSpacing, 
/* 197 */         this.tileMargin);
