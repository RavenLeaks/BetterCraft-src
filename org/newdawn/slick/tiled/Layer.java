...
/*     */     } 
/*     */     
/*  92 */     Element dataNode = (Element)element.getElementsByTagName("data").item(
/*  93 */         0);
...
/* 102 */         GZIPInputStream is = new GZIPInputStream(
/* 103 */             new ByteArrayInputStream(dec));
/*     */         
...
/*     */       } 
/*     */     } else {
/* 133 */       throw new SlickException("Unsupport tiled map type: " + encoding + 
/* 134 */           "," + compression + " (only gzip base64 supported)");
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */               
/* 224 */               set.tiles.renderInUse(x + tx * mapTileWidth, y + 
...
/* 287 */           "Data length appears to be wrong (wrote " + index + 
/* 288 */           " should be " + out.length + ")");
/*     */     }
/*     */     
/* 291 */     return out;
/*     */   }
