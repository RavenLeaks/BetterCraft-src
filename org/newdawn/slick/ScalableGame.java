...
/*     */     }
/* 108 */     this.container.getInput().setScale(this.normalWidth / this.targetWidth, 
/* 109 */         this.normalHeight / this.targetHeight);
/*     */ 
/*     */     
/* 112 */     int yoffset = 0;
/* 113 */     int xoffset = 0;
...
/*     */     }
/* 121 */     this.container.getInput().setOffset(-xoffset / this.targetWidth / this.normalWidth, 
/* 122 */         -yoffset / this.targetHeight / this.normalHeight);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 130 */     if (this.targetHeight != container.getHeight() || 
/* 131 */       this.targetWidth != container.getWidth()) {
