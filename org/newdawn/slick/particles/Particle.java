...
/*     */   
/*     */   public void render() {
/* 154 */     if ((this.engine.usePoints() && this.usePoints == 1) || 
/* 155 */       this.usePoints == 2) {
...
/*     */       
/* 176 */       this.image.draw((int)-(this.size / 2.0F), (int)-(this.size / 2.0F), (int)this.size, 
/* 177 */           (int)this.size, this.color);
/* 178 */       GL.glPopMatrix();
/*     */     } else {
/* 180 */       this.color.bind();
/* 181 */       this.image.drawEmbedded((int)(this.x - this.size / 2.0F), (int)(this.y - this.size / 2.0F), 
/* 182 */           (int)this.size, (int)this.size);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 464 */     return String.valueOf(super.toString()) + " : " + this.life;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
