...
/*     */       try {
/* 293 */         this.image = new Image(String.valueOf(relativePath) + this.imageName);
...
/*     */     
/* 300 */     if ((this.wrapUp || (
/* 301 */       this.length.isEnabled() && this.timeout < 0) || (
/* 302 */       this.emitCount.isEnabled() && this.leftToEmit <= 0)) && 
/* 303 */       this.particleCount == 0) {
...
/* 340 */           float ang = s + this.angularOffset.getValue(0.0F) - this.spread
/* 341 */             .getValue() / 2.0F - 90.0F;
...
/* 356 */         p.setColor(start.col.r, start.col.g, start.col.b, this.startAlpha
/* 357 */             .getValue(0.0F) / 255.0F);
...
/*     */     
/* 382 */     particle.adjustVelocity(this.windFactor.getValue(0.0F) * 5.0E-5F * delta, this.gravityFactor
/* 383 */         .getValue(0.0F) * 5.0E-5F * delta);
/*     */     
...
/*     */       } else {
/* 417 */         a = this.startAlpha.getValue(0.0F) / 255.0F * offset + 
/* 418 */           this.endAlpha.getValue(0.0F) / 255.0F * inv;
/*     */       } 
...
/*     */           
/* 686 */           float st = (t - p0.getX()) / (
/* 687 */             p1.getX() - p0.getX());
/* 688 */           float r = p0.getY() + st * (
/* 689 */             p1.getY() - p0.getY());
/*     */ 
/*     */ 
/*     */           
...
/* 895 */     return !((this.usePoints != 1 || !system.usePoints()) && 
/* 896 */       this.usePoints != 2);
/*     */   }
/*     */   
