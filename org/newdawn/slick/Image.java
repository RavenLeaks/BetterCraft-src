...
/*  578 */       GL.glTexCoord2f(this.textureOffsetX + this.textureWidth, this.textureOffsetY + 
/*  579 */           this.textureHeight);
...
/*  591 */       GL.glTexCoord2f(this.textureOffsetX + this.textureWidth, this.textureOffsetY + 
/*  592 */           this.textureHeight);
...
/*  735 */     GL.glTexCoord2f(this.textureOffsetX + this.textureWidth, this.textureOffsetY + 
/*  736 */         this.textureHeight);
...
/*  855 */       GL.glSecondaryColor3ubEXT((byte)(int)(col.r * 255.0F), 
/*  856 */           (byte)(int)(col.g * 255.0F), 
/*  857 */           (byte)(int)(col.b * 255.0F));
/*      */     } 
/*      */     
...
/*      */     
/* 1100 */     float newTextureOffsetX = srcx / this.width * this.textureWidth + 
/* 1101 */       this.textureOffsetX;
/* 1102 */     float newTextureOffsetY = srcy / this.height * this.textureHeight + 
/* 1103 */       this.textureOffsetY;
/* 1104 */     float newTextureWidth = texwidth / this.width * 
/* 1105 */       this.textureWidth;
/* 1106 */     float newTextureHeight = texheight / this.height * 
/* 1107 */       this.textureHeight;
/*      */     
/* 1109 */     GL.glTexCoord2f(newTextureOffsetX, newTextureOffsetY);
/* 1110 */     GL.glVertex3f(x, y, 0.0F);
/* 1111 */     GL.glTexCoord2f(newTextureOffsetX, newTextureOffsetY + 
/* 1112 */         newTextureHeight);
/* 1113 */     GL.glVertex3f(x, y + myheight, 0.0F);
/* 1114 */     GL.glTexCoord2f(newTextureOffsetX + newTextureWidth, 
/* 1115 */         newTextureOffsetY + newTextureHeight);
/* 1116 */     GL.glVertex3f(x + mywidth, y + myheight, 0.0F);
/* 1117 */     GL.glTexCoord2f(newTextureOffsetX + newTextureWidth, 
...
/* 1153 */     GL.glTexCoord2f(this.textureOffsetX + this.textureWidth, this.textureOffsetY + 
/* 1154 */         this.textureHeight);
...
/* 1364 */       return new Color(translate(this.pixelData[offset]), translate(this.pixelData[offset + 1]), 
/* 1365 */           translate(this.pixelData[offset + 2]), translate(this.pixelData[offset + 3]));
/*      */     }
/* 1367 */     return new Color(translate(this.pixelData[offset]), translate(this.pixelData[offset + 1]), 
/* 1368 */         translate(this.pixelData[offset + 2]));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
