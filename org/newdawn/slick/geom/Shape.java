...
/* 454 */         y2 = yold;
/*     */       } 
/* 456 */       if (((xnew < x) ? true : false) == ((x <= xold) ? true : false) && (
/* 457 */         y - y1) * (x2 - x1) < (
/* 458 */         y2 - y1) * (x - x1)) {
/* 459 */         result = !result;
/*     */       }
...
/*     */         }
/*     */         
/* 526 */         double unknownA = ((points[iNext] - points[i]) * (thatPoints[j + 1] - points[i + 1]) - ((
/* 527 */           points[iNext + 1] - points[i + 1]) * (thatPoints[j] - points[i]))) / ((
/* 528 */           points[iNext + 1] - points[i + 1]) * (thatPoints[jNext] - thatPoints[j]) - (
/* 529 */           points[iNext] - points[i]) * (thatPoints[jNext + 1] - thatPoints[j + 1]));
/* 530 */         double unknownB = ((thatPoints[jNext] - thatPoints[j]) * (thatPoints[j + 1] - points[i + 1]) - ((
/* 531 */           thatPoints[jNext + 1] - thatPoints[j + 1]) * (thatPoints[j] - points[i]))) / ((
/* 532 */           points[iNext + 1] - points[i + 1]) * (thatPoints[jNext] - thatPoints[j]) - (
/* 533 */           points[iNext] - points[i]) * (thatPoints[jNext + 1] - thatPoints[j + 1]));
/*     */         
...
/* 594 */       float temp = (this.points[i] - this.center[0]) * (this.points[i] - this.center[0]) + (
/* 595 */         this.points[i + 1] - this.center[1]) * (this.points[i + 1] - this.center[1]);
