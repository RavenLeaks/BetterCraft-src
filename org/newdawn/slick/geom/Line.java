...
/*     */     }
/*     */     
/* 422 */     float ua = dx2 * (this.start.getY() - other.start.getY()) - 
/* 423 */       dy2 * (this.start.getX() - other.start.getX());
/* 424 */     ua /= denom;
/* 425 */     float ub = dx1 * (this.start.getY() - other.start.getY()) - 
/* 426 */       dy1 * (this.start.getX() - other.start.getX());
/* 427 */     ub /= denom;
/*     */     
