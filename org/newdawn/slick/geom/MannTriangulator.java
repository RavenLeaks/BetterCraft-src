...
/*     */           label54: while (true)
/* 122 */           { if (pHole.isInfront(pContour) && 
/* 123 */               pContour.isInfront(pHole) && 
/* 124 */               !this.contour.doesIntersectSegment(pHole.pt, 
/* 125 */                 pContour.pt)) {
/* 126 */               PointBag pointBag = this.holes;
/*     */               
/* 128 */               while (!pointBag.doesIntersectSegment(pHole.pt, 
/* 129 */                   pContour.pt)) {
/*     */ 
/*     */                 
...
/*     */ 
/*     */                   
/* 152 */                   this.holes.first = null; break label57;
/*     */                 } 
/*     */               } 
/*     */             } 
...
/* 441 */       boolean sidePrev = ((this.prev.pt.y - this.pt.y) * dx + (this.pt.x - this.prev.pt.x) * 
/* 442 */         dy >= 0.0D);
/* 443 */       boolean sideNext = ((this.pt.y - this.next.pt.y) * dx + (this.next.pt.x - this.pt.x) * 
/* 444 */         dy >= 0.0D);
/*     */       
