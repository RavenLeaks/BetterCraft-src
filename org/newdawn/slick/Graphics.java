...
/*      */             public Object run() {
/*      */               try {
/*  141 */                 Graphics.DEFAULT_FONT = new AngelCodeFont(
/*  142 */                     "org/newdawn/slick/data/defaultfont.fnt", 
/*  143 */                     "org/newdawn/slick/data/defaultfont.png");
...
/*  762 */       clearWorldClip();
/*      */     } else {
/*  764 */       setWorldClip(clip.getX(), clip.getY(), clip.getWidth(), clip
/*  765 */           .getHeight());
/*      */     } 
/*      */   }
/*      */ 
...
/*      */       return;
/*      */     } 
/*  821 */     setClip((int)rect.getX(), (int)rect.getY(), (int)rect.getWidth(), 
...
/*      */         }
/*      */         
/* 1139 */         float x = (float)(cx + FastTrig.cos(Math.toRadians((ang + 10.0F))) * 
/* 1140 */           width / 2.0D);
/* 1141 */         float y = (float)(cy + FastTrig.sin(Math.toRadians((ang + 10.0F))) * 
/* 1142 */           height / 2.0D);
/*      */         
...
/* 1204 */     drawLine(x + width, y + cornerRadius, x + width, y + height - 
/* 1205 */         cornerRadius);
/* 1206 */     drawLine(x + cornerRadius, y + height, x + width - cornerRadius, y + 
/* 1207 */         height);
/*      */     
...
/* 1274 */     fillRect(x + width - cornerRadius, y + cornerRadius, cornerRadius, 
/* 1275 */         height - d);
/* 1276 */     fillRect(x + cornerRadius, y + height - cornerRadius, width - d, 
/* 1277 */         cornerRadius);
...
/* 1496 */     drawImage(image, x, y, x + image.getWidth(), y + image.getHeight(), 
...
/* 1513 */     target.bind();
/* 1514 */     GL.glCopyTexImage2D(3553, 0, format, x, this.screenHeight - 
...
/* 1545 */     predraw();
/* 1546 */     GL.glReadPixels(x, this.screenHeight - y, 1, 1, 6408, 
/* 1547 */         5121, this.readBuffer);
/* 1548 */     postdraw();
/*      */     
/* 1550 */     return new Color(translate(this.readBuffer.get(0)), translate(this.readBuffer
/* 1551 */           .get(1)), translate(this.readBuffer.get(2)), translate(this.readBuffer
/* 1552 */           .get(3)));
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/* 1571 */     predraw();
/* 1572 */     GL.glReadPixels(x, this.screenHeight - y - height, width, height, 6408, 
/* 1573 */         5121, target);
/* 1574 */     postdraw();
/*      */   }
/*      */ 
...
/* 1641 */     drawImage(image, x, y, x + image.getWidth(), y + image.getHeight(), 
