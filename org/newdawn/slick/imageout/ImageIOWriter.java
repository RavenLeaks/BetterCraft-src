...
/* 65 */       sampleModel = new PixelInterleavedSampleModel(
/* 66 */           0, image.getWidth(), image.getHeight(), 4, 
/* 67 */           4 * image.getWidth(), offsets);
/*    */       
/* 69 */       cm = new ComponentColorModel(
/* 70 */           ColorSpace.getInstance(1000), new int[] { 8, 8, 8, 8
/* 71 */           }, true, false, 3, 
/* 72 */           0);
/*    */     } else {
/* 74 */       int[] offsets = { 0, 1, 2 };
/* 75 */       sampleModel = new PixelInterleavedSampleModel(
/* 76 */           0, image.getWidth(), image.getHeight(), 3, 
/* 77 */           3 * image.getWidth(), offsets);
/*    */       
/* 79 */       cm = new ComponentColorModel(ColorSpace.getInstance(1000), 
/* 80 */           new int[] { 8, 8, 8
/* 81 */           }, false, 
/* 82 */           false, 
/* 83 */           1, 
