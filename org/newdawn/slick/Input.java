...
/*      */     } 
/*      */     
/*  886 */     return !(((Controller)controllers.get(controller)).getXAxisValue() >= -0.5F && (
/*  887 */       (Controller)controllers.get(controller)).getPovX() >= -0.5F);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/*  911 */     return !(((Controller)controllers.get(controller)).getXAxisValue() <= 0.5F && (
/*  912 */       (Controller)controllers.get(controller)).getPovX() <= 0.5F);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  933 */       return false;
/*      */     } 
/*  935 */     return !(((Controller)controllers.get(controller)).getYAxisValue() >= -0.5F && (
/*  936 */       (Controller)controllers.get(controller)).getPovY() >= -0.5F);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/*  960 */     return !(((Controller)controllers.get(controller)).getYAxisValue() <= 0.5F && (
/*  961 */       (Controller)controllers.get(controller)).getPovY() <= 0.5F);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1045 */         Log.info(String.valueOf(i) + " : " + ((Controller)controllers.get(i)).getName());
/*      */       }
...
/* 1052 */     } catch (NoClassDefFoundError noClassDefFoundError) {}
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1132 */       clearMousePressedRecord(); do {
/*      */       
/* 1134 */       } while (Keyboard.next()); do {  }
...
/* 1229 */         if (this.pressedX != -1 && 
/* 1230 */           this.pressedY != -1 && 
/* 1231 */           Math.abs(this.pressedX - releasedX) < this.mouseClickTolerance && 
/* 1232 */           Math.abs(this.pressedY - releasedY) < this.mouseClickTolerance) {
