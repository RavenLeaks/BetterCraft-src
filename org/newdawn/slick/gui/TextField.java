...
/*     */         
/* 374 */         if (key == 47 && (
/* 375 */           this.input.isKeyDown(29) || this.input.isKeyDown(157))) {
...
/*     */         } 
/* 382 */         if (key == 44 && (
/* 383 */           this.input.isKeyDown(29) || this.input.isKeyDown(157))) {
...
/* 426 */             this.value = String.valueOf(this.value.substring(0, this.cursorPos - 1)) + 
/* 427 */               this.value.substring(this.cursorPos);
/*     */           } else {
...
/* 439 */           this.value = String.valueOf(this.value.substring(0, this.cursorPos)) + this.value.substring(this.cursorPos + 1);
/*     */         }
/*     */         
/* 442 */         if (this.consume) {
...
/* 447 */           this.value = String.valueOf(this.value.substring(0, this.cursorPos)) + c + 
/* 448 */             this.value.substring(this.cursorPos);
/*     */         } else {
/* 450 */           this.value = String.valueOf(this.value.substring(0, this.cursorPos)) + c;
/*     */         } 
/* 452 */         this.cursorPos++;
/*     */         
/* 454 */         if (this.consume) {
