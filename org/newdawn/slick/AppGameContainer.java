...
/*     */ 
/*     */             
/* 134 */             if (current.getBitsPerPixel() == this.originalDisplayMode.getBitsPerPixel() && 
/* 135 */               current.getFrequency() == this.originalDisplayMode.getFrequency()) {
...
/*     */           public Object run() {
/*     */             try {
/* 351 */               PixelFormat format = new PixelFormat(8, 8, AppGameContainer.stencil ? 8 : 0, AppGameContainer.this.samples);
/*     */               
...
/*     */               
/*     */               try {
/* 359 */                 PixelFormat format = new PixelFormat(8, 8, AppGameContainer.stencil ? 8 : 0);
/*     */                 
...
/* 408 */       try { Thread.sleep(100L); } catch (Exception exception) {} }
/*     */     else
/*     */     { try {
