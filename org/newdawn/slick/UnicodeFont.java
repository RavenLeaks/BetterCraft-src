...
/*     */     try {
/* 233 */       attributes.put(TextAttribute.class.getDeclaredField("KERNING").get((Object)null), TextAttribute.class.getDeclaredField(
/* 234 */             "KERNING_ON").get((Object)null));
...
/* 394 */       } catch (SlickException slickException) {}
/*     */     } 
/*     */     
...
/*     */       
/*     */       try {
/* 946 */         Object font2D = Class.forName("sun.font.FontManager").getDeclaredMethod("getFont2D", new Class[] { Font.class
/* 947 */             }).invoke(null, new Object[] { this.font });
