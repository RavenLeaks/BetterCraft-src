...
/* 125 */     BufferedImage tempfontImage = new BufferedImage(1, 1, 
/* 126 */         2);
...
/*     */ 
/*     */     
/* 146 */     BufferedImage fontImage = new BufferedImage(charwidth, charheight, 
/* 147 */         2);
/* 148 */     Graphics2D gt = (Graphics2D)fontImage.getGraphics();
/* 149 */     if (this.antiAlias) {
/* 150 */       gt.setRenderingHint(RenderingHints.KEY_ANTIALIASING, 
...
/* 159 */         this.fontMetrics.getAscent());
/*     */     
...
/*     */       } 
/*     */       
/* 237 */       this.fontTexture = 
/* 238 */         BufferedImageUtil.getTexture(this.font.toString(), imgTemp);
/*     */     }
