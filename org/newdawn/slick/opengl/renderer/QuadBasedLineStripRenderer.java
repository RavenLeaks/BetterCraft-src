...
/* 224 */         for (int j = 0; j < 180.0F + step; j = (int)(j + step)) {
/* 225 */           float ang = (float)Math.toRadians((fang + j));
/* 226 */           this.GL.glVertex2f(points[0] + (float)(Math.cos(ang) * width), 
/* 227 */               points[1] + (float)(Math.sin(ang) * width));
/*     */         } 
/* 229 */         this.GL.glEnd();
/*     */       } 
/*     */     } 
...
/* 243 */         for (int j = 0; j < 180.0F + step; j = (int)(j + step)) {
/* 244 */           float ang = (float)Math.toRadians((fang + j));
/* 245 */           this.GL.glVertex2f(points[count * 2 - 2] + (float)(Math.cos(ang) * width), 
/* 246 */               points[count * 2 - 1] + (float)(Math.sin(ang) * width));
/*     */         } 
/* 248 */         this.GL.glEnd();
/*     */       } 
/*     */     } 
...
/* 261 */         this.GL.glColor4f(this.colours[index * 4] * 0.5F, this.colours[index * 4 + 1] * 0.5F, 
/* 262 */             this.colours[index * 4 + 2] * 0.5F, this.colours[index * 4 + 3] * 0.5F);
/*     */       } else {
/* 264 */         this.GL.glColor4f(this.colours[index * 4], this.colours[index * 4 + 1], 
/* 265 */             this.colours[index * 4 + 2], this.colours[index * 4 + 3]);
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
