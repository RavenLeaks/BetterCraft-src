...
/* 148 */     return !(this.colorType != 6 && 
/* 149 */       this.paletteA == null && this.transPixel == null);
/*     */   }
/*     */   
/*     */   public boolean isRGB() {
/* 153 */     return !(this.colorType != 6 && 
/* 154 */       this.colorType != 2 && 
/* 155 */       this.colorType != 3);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 737 */     return 
/* 738 */       buffer[offset] << 24 | (
/* 739 */       buffer[offset + 1] & 0xFF) << 16 | (
/* 740 */       buffer[offset + 2] & 0xFF) << 8 | 
/* 741 */       buffer[offset + 3] & 0xFF;
/*     */   }
/*     */   
