...
/*    */   implements Runnable
/*    */ {
/* 10 */   private static final ThreadedFileIOBase INSTANCE = new ThreadedFileIOBase();
/* 11 */   private final List<IThreadedFileIO> threadedIOQueue = Collections.synchronizedList(Lists.newArrayList());
/*    */   
...
/* 83 */     if (!this.threadedIOQueue.contains(fileIo)) {
/*    */       
/* 85 */       this.writeQueuedCounter++;
/* 86 */       this.threadedIOQueue.add(fileIo);
/*    */     } 
/*    */   }
/*    */ 
/*    */   
