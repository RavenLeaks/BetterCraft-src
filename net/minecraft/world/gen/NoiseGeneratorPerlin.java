...
/* 12 */     this.levels = p_i45470_2_;
/* 13 */     this.noiseLevels = new NoiseGeneratorSimplex[p_i45470_2_];
/*    */     
/* 15 */     for (int i = 0; i < p_i45470_2_; i++)
/*    */     {
/* 17 */       this.noiseLevels[i] = new NoiseGeneratorSimplex(p_i45470_1_);
/*    */     }
/*    */   }
/*    */ 
/*    */   
...
/* 24 */     double d1 = 1.0D;
/*    */     
/* 26 */     for (int i = 0; i < this.levels; i++) {
/*    */       
/* 28 */       d0 += this.noiseLevels[i].getValue(p_151601_1_ * d1, p_151601_3_ * d1) / d1;
/* 29 */       d1 /= 2.0D;
/*    */     } 
/*    */     
/* 32 */     return d0;
...
/* 37 */     return getRegion(p_151599_1_, p_151599_2_, p_151599_4_, p_151599_6_, p_151599_7_, p_151599_8_, p_151599_10_, p_151599_12_, 0.5D);
/*    */   }
/*    */ 
/*    */   
...
/* 55 */     double d0 = 1.0D;
/*    */     
/* 57 */     for (int j = 0; j < this.levels; j++) {
/*    */       
/* 59 */       this.noiseLevels[j].add(p_151600_1_, p_151600_2_, p_151600_4_, p_151600_6_, p_151600_7_, p_151600_8_ * d0 * d1, p_151600_10_ * d0 * d1, 0.55D / d1);
/* 60 */       d0 *= p_151600_12_;
/* 61 */       d1 *= p_151600_14_;
/*    */     } 
/*    */     
