...
/*  35 */     boolean[] aboolean = new boolean[2048];
...
/*     */           
/*  73 */           boolean flag = (!aboolean[(k1 * 16 + l2) * 8 + k] && ((k1 < 15 && aboolean[((k1 + 1) * 16 + l2) * 8 + k]) || (k1 > 0 && aboolean[((k1 - 1) * 16 + l2) * 8 + k]) || (l2 < 15 && aboolean[(k1 * 16 + l2 + 1) * 8 + k]) || (l2 > 0 && aboolean[(k1 * 16 + l2 - 1) * 8 + k]) || (k < 7 && aboolean[(k1 * 16 + l2) * 8 + k + 1]) || (k > 0 && aboolean[(k1 * 16 + l2) * 8 + k - 1])));
/*     */           
/*  75 */           if (flag) {
/*     */             
/*  77 */             Material material = worldIn.getBlockState(position.add(k1, k, l2)).getMaterial();
/*     */             
...
/*     */           
/* 113 */           if (aboolean[(i2 * 16 + j3) * 8 + j4]) {
/*     */             
/* 115 */             BlockPos blockpos = position.add(i2, j4 - 1, j3);
/*     */             
/* 117 */             if (worldIn.getBlockState(blockpos).getBlock() == Blocks.DIRT && worldIn.getLightFor(EnumSkyBlock.SKY, position.add(i2, j4, j3)) > 0) {
/*     */               
/* 119 */               Biome biome = worldIn.getBiome(blockpos);
/*     */               
/* 121 */               if (biome.topBlock.getBlock() == Blocks.MYCELIUM) {
/*     */                 
...
/*     */     } 
/*     */     
/* 135 */     if (this.block.getDefaultState().getMaterial() == Material.LAVA)
/*     */     {
...
/*     */             
/* 143 */             boolean flag1 = (!aboolean[(j2 * 16 + k3) * 8 + k4] && ((j2 < 15 && aboolean[((j2 + 1) * 16 + k3) * 8 + k4]) || (j2 > 0 && aboolean[((j2 - 1) * 16 + k3) * 8 + k4]) || (k3 < 15 && aboolean[(j2 * 16 + k3 + 1) * 8 + k4]) || (k3 > 0 && aboolean[(j2 * 16 + k3 - 1) * 8 + k4]) || (k4 < 7 && aboolean[(j2 * 16 + k3) * 8 + k4 + 1]) || (k4 > 0 && aboolean[(j2 * 16 + k3) * 8 + k4 - 1])));
/*     */             
/* 145 */             if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid())
/*     */             {
...
/*     */     }
/*     */     
/* 154 */     if (this.block.getDefaultState().getMaterial() == Material.WATER)
/*     */     {
...
/* 160 */           int l4 = 4;
/*     */           
/* 162 */           if (worldIn.canBlockFreezeWater(position.add(k2, 4, l3)))
/*     */           {
/* 164 */             worldIn.setBlockState(position.add(k2, 4, l3), Blocks.ICE.getDefaultState(), 2);
/*     */           }
/*     */         } 
/*     */       } 
/*     */     }
