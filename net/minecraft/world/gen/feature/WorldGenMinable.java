...
/*  22 */     this(state, blockCount, new StonePredicate(null));
/*     */   }
/*     */ 
/*     */   
...
/*  51 */       int j = MathHelper.floor(d6 - d10 / 2.0D);
/*  52 */       int k = MathHelper.floor(d7 - d11 / 2.0D);
/*  53 */       int l = MathHelper.floor(d8 - d10 / 2.0D);
/*  54 */       int i1 = MathHelper.floor(d6 + d10 / 2.0D);
/*  55 */       int j1 = MathHelper.floor(d7 + d11 / 2.0D);
/*  56 */       int k1 = MathHelper.floor(d8 + d10 / 2.0D);
/*     */       
...
/* 101 */       if (p_apply_1_ != null && p_apply_1_.getBlock() == Blocks.STONE) {
/*     */         
/* 103 */         BlockStone.EnumType blockstone$enumtype = (BlockStone.EnumType)p_apply_1_.getValue((IProperty)BlockStone.VARIANT);
/* 104 */         return blockstone$enumtype.func_190912_e();
/*     */       } 
/*     */ 
/*     */       
/* 108 */       return false;
