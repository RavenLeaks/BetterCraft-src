...
/*     */   
/*  36 */   private static final ParameterizedType USER_LIST_ENTRY_TYPE = new ParameterizedType()
/*     */     {
...
/*  95 */     this.values.remove(getObjectKey(entry));
/*     */ 
/*     */     
/*     */     try {
/*  99 */       writeChanges();
...
/*     */     
/*     */     try {
/* 164 */       bufferedwriter = Files.newWriter(this.saveFile, StandardCharsets.UTF_8);
...
/* 191 */         return UserList.this.createEntry(jsonobject);
/*     */       } 
/*     */ 
/*     */       
/* 195 */       return null;
