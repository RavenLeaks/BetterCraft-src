...
/*    */       else {
/*    */         
/* 36 */         if (i < this.threshold)
/*    */         {
/* 38 */           throw new DecoderException("Badly compressed packet - size of " + i + " is below server threshold of " + this.threshold);
/*    */         }
/*    */         
/* 41 */         if (i > 2097152)
/*    */         {
