...
/* 18 */     spawnDispenseParticles(source, (EnumFacing)source.getBlockState().getValue((IProperty)BlockDispenser.FACING));
/* 19 */     return itemstack;
/*    */   }
/*    */ 
/*    */ 
...
/* 27 */     EnumFacing enumfacing = (EnumFacing)source.getBlockState().getValue((IProperty)BlockDispenser.FACING);
...
/* 57 */     worldIn.spawnEntityInWorld((Entity)entityitem);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 73 */     source.getWorld().playEvent(2000, source.getBlockPos(), getWorldEventDataFrom(facingIn));
/*    */   }
/*    */ 
/*    */   
