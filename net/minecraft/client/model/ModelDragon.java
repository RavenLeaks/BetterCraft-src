...
/*  72 */     this.head.addBox("upperlip", -6.0F, -1.0F, -24.0F, 12, 5, 16);
/*  73 */     this.head.addBox("upperhead", -8.0F, -8.0F, -10.0F, 16, 16, 16);
/*  74 */     this.head.mirror = true;
/*  75 */     this.head.addBox("scale", -5.0F, -12.0F, -4.0F, 2, 4, 6);
/*  76 */     this.head.addBox("nostril", -5.0F, -3.0F, -22.0F, 2, 2, 4);
/*  77 */     this.head.mirror = false;
/*  78 */     this.head.addBox("scale", 3.0F, -12.0F, -4.0F, 2, 4, 6);
/*  79 */     this.head.addBox("nostril", 3.0F, -3.0F, -22.0F, 2, 2, 4);
/*  80 */     this.jaw = new ModelRenderer(this, "jaw");
/*  81 */     this.jaw.setRotationPoint(0.0F, 4.0F, -8.0F);
...
/* 143 */     this.jaw.rotateAngleX = (float)(Math.sin((f * 6.2831855F)) + 1.0D) * 0.2F;
/* 144 */     float f1 = (float)(Math.sin((f * 6.2831855F - 1.0F)) + 1.0D);
/* 145 */     f1 = (f1 * f1 + f1 * 2.0F) * 0.05F;
...
/* 154 */     float f8 = f * 6.2831855F;
/* 155 */     f2 = 20.0F;
/* 156 */     float f3 = -12.0F;
/*     */     
/* 158 */     for (int i = 0; i < 5; i++) {
/*     */       
/* 160 */       double[] adouble1 = entitydragon.getMovementOffsets(5 - i, this.partialTicks);
/* 161 */       float f9 = (float)Math.cos((i * 0.45F + f8)) * 0.15F;
/* 162 */       this.spine.rotateAngleY = updateRotations(adouble1[0] - adouble[0]) * 0.017453292F * 1.5F;
/* 163 */       this.spine.rotateAngleX = f9 + entitydragon.getHeadPartYOffset(i, adouble, adouble1) * 0.017453292F * 1.5F * 5.0F;
/* 164 */       this.spine.rotateAngleZ = -updateRotations(adouble1[0] - f7) * 0.017453292F * 1.5F;
/* 165 */       this.spine.rotationPointY = f2;
/* 166 */       this.spine.rotationPointZ = f3;
/* 167 */       this.spine.rotationPointX = f4;
/* 168 */       f2 = (float)(f2 + Math.sin(this.spine.rotateAngleX) * 10.0D);
/* 169 */       f3 = (float)(f3 - Math.cos(this.spine.rotateAngleY) * Math.cos(this.spine.rotateAngleX) * 10.0D);
/* 170 */       f4 = (float)(f4 - Math.sin(this.spine.rotateAngleY) * Math.cos(this.spine.rotateAngleX) * 10.0D);
/* 171 */       this.spine.render(scale);
/*     */     } 
/*     */     
/* 174 */     this.head.rotationPointY = f2;
/* 175 */     this.head.rotationPointZ = f3;
/* 176 */     this.head.rotationPointX = f4;
/* 177 */     double[] adouble2 = entitydragon.getMovementOffsets(0, this.partialTicks);
/* 178 */     this.head.rotateAngleY = updateRotations(adouble2[0] - adouble[0]) * 0.017453292F;
/* 179 */     this.head.rotateAngleX = updateRotations(entitydragon.getHeadPartYOffset(6, adouble, adouble2)) * 0.017453292F * 1.5F * 5.0F;
/* 180 */     this.head.rotateAngleZ = -updateRotations(adouble2[0] - f7) * 0.017453292F;
/* 181 */     this.head.render(scale);
/* 182 */     GlStateManager.pushMatrix();
/* 183 */     GlStateManager.translate(0.0F, 1.0F, 0.0F);
/* 184 */     GlStateManager.rotate(-f6 * 1.5F, 0.0F, 0.0F, 1.0F);
...
/* 208 */       if (j == 0)
/*     */       {
/* 210 */         GlStateManager.cullFace(GlStateManager.CullFace.FRONT);
/*     */       }
/*     */     } 
/*     */     
/* 214 */     GlStateManager.popMatrix();
/* 215 */     GlStateManager.cullFace(GlStateManager.CullFace.BACK);
/* 216 */     GlStateManager.disableCull();
/* 217 */     float f10 = -((float)Math.sin((f * 6.2831855F))) * 0.0F;
/* 218 */     f8 = f * 6.2831855F;
/* 219 */     f2 = 10.0F;
/* 220 */     f3 = 60.0F;
/* 221 */     f4 = 0.0F;
...
/* 228 */       this.spine.rotateAngleY = (updateRotations(adouble2[0] - adouble[0]) * 1.5F + 180.0F) * 0.017453292F;
/* 229 */       this.spine.rotateAngleX = f10 + (float)(adouble2[1] - adouble[1]) * 0.017453292F * 1.5F * 5.0F;
/* 230 */       this.spine.rotateAngleZ = updateRotations(adouble2[0] - f7) * 0.017453292F * 1.5F;
