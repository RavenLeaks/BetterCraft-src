...
/* 64 */     this.core.render(scale); byte b; int i;
/*    */     ModelRenderer[] arrayOfModelRenderer;
/* 66 */     for (i = (arrayOfModelRenderer = this.segments).length, b = 0; b < i; ) { ModelRenderer modelrenderer = arrayOfModelRenderer[b];
/*    */       
/* 68 */       modelrenderer.render(scale);
/*    */       b++; }
/*    */   
/*    */   }
/*    */ }
