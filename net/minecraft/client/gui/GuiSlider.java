...
/*  39 */     if (p_175218_2_)
/*     */     {
/*  41 */       this.responder.setEntryValue(this.id, getSliderValue());
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*  52 */     return (this.formatHelper == null) ? (String.valueOf(I18n.format(this.name, new Object[0])) + ": " + getSliderValue()) : this.formatHelper.getText(this.id, I18n.format(this.name, new Object[0]), getSliderValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  86 */         this.responder.setEntryValue(this.id, getSliderValue());
/*     */       } 
/*     */       
...
/*  99 */     this.responder.setEntryValue(this.id, getSliderValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 123 */       this.responder.setEntryValue(this.id, getSliderValue());
