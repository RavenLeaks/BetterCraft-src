...
/*  16 */   private final List<String> listLines = Lists.newArrayList();
/*     */   
...
/*  54 */     this.listLines.clear();
/*  55 */     this.listLines.addAll(this.fontRendererObj.listFormattedStringToWidth(this.messageLine2, this.width - 50));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  73 */     int i = 90;
/*     */     
/*  75 */     for (String s : this.listLines) {
/*     */       
