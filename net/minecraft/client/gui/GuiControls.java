...
/*  41 */     this.buttonList.add(new GuiButton(200, this.width / 2 - 155 + 160, this.height - 29, 150, 20, I18n.format("gui.done", new Object[0])));
/*  42 */     this.buttonReset = addButton(new GuiButton(201, this.width / 2 - 155, this.height - 29, 150, 20, I18n.format("controls.resetAll", new Object[0])));
/*  43 */     this.screenTitle = I18n.format("controls.title", new Object[0]);
/*  44 */     int i = 0; byte b; int j;
/*     */     GameSettings.Options[] arrayOfOptions;
/*  46 */     for (j = (arrayOfOptions = OPTIONS_ARR).length, b = 0; b < j; ) { GameSettings.Options gamesettings$options = arrayOfOptions[b];
/*     */       
...
/* 162 */     boolean flag = false; byte b; int i;
