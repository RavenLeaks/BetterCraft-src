...
/*  45 */     this.doneBtn = addButton(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120, I18n.format("gui.done", new Object[0])));
...
/*  55 */     NetHandlerPlayClient nethandlerplayclient = this.mc.getConnection();
/*     */     
/*  57 */     if (nethandlerplayclient != null)
/*     */     {
/*  59 */       nethandlerplayclient.sendPacket((Packet)new CPacketUpdateSign(this.tileSign.getPos(), this.tileSign.signText));
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 111 */     if (ChatAllowedCharacters.isAllowedCharacter(typedChar) && this.fontRendererObj.getStringWidth(String.valueOf(s) + typedChar) <= 90)
/*     */     {
/* 113 */       s = String.valueOf(s) + typedChar;
/*     */     }
/*     */     
/* 116 */     this.tileSign.signText[this.editLine] = (ITextComponent)new TextComponentString(s);
/*     */     
/* 118 */     if (keyCode == 1)
/*     */     {
...
/* 134 */     float f = 93.75F;
/* 135 */     GlStateManager.scale(-93.75F, -93.75F, -93.75F);
