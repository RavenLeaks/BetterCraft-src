...
/*  72 */     if (element.isJsonPrimitive())
/*     */     {
/*  74 */       return new AnimationFrame(JsonUtils.getInt(element, "frames[" + frame + "]"));
/*     */     }
/*  76 */     if (element.isJsonObject()) {
/*     */       
/*  78 */       JsonObject jsonobject = JsonUtils.getJsonObject(element, "frames[" + frame + "]");
...
/*     */         else {
/*     */           
/* 126 */           jsonarray.add((JsonElement)new JsonPrimitive(Integer.valueOf(p_serialize_1_.getFrameIndex(i))));
/*     */         } 
/*     */       } 
/*     */       
/* 130 */       jsonobject.add("frames", (JsonElement)jsonarray);
/*     */     } 
/*     */     
