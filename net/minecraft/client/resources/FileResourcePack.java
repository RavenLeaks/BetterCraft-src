...
/*  19 */   public static final Splitter ENTRY_NAME_SPLITTER = Splitter.on('/').omitEmptyStrings().limit(3);
/*     */   
...
/*     */       
/*  82 */       ZipEntry zipentry = enumeration.nextElement();
/*  83 */       String s = zipentry.getName();
/*     */       
/*  85 */       if (s.startsWith("assets/")) {
/*     */         
/*  87 */         List<String> list = Lists.newArrayList(ENTRY_NAME_SPLITTER.split(s));
/*     */         
/*  89 */         if (list.size() > 1) {
/*     */           
/*  91 */           String s1 = list.get(1);
/*     */           
/*  93 */           if (s1.equals(s1.toLowerCase(Locale.ROOT))) {
/*     */             
/*  95 */             set.add(s1);
/*     */             
/*     */             continue;
/*     */           } 
/*  99 */           logNameNotLowercase(s1);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */ 
