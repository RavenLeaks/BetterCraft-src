...
/* 41 */     return (this.rotation.equals(itemtransformvec3f.rotation) && this.scale.equals(itemtransformvec3f.scale) && this.translation.equals(itemtransformvec3f.translation));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 65 */       vector3f1.x = MathHelper.clamp(vector3f1.x, -5.0F, 5.0F);
/* 66 */       vector3f1.y = MathHelper.clamp(vector3f1.y, -5.0F, 5.0F);
/* 67 */       vector3f1.z = MathHelper.clamp(vector3f1.z, -5.0F, 5.0F);
/* 68 */       Vector3f vector3f2 = parseVector3f(jsonobject, "scale", SCALE_DEFAULT);
/* 69 */       vector3f2.x = MathHelper.clamp(vector3f2.x, -4.0F, 4.0F);
/* 70 */       vector3f2.y = MathHelper.clamp(vector3f2.y, -4.0F, 4.0F);
/* 71 */       vector3f2.z = MathHelper.clamp(vector3f2.z, -4.0F, 4.0F);
...
/*    */       {
/* 95 */         afloat[i] = JsonUtils.getFloat(jsonarray.get(i), String.valueOf(key) + "[" + i + "]");
/*    */       }
/*    */       
