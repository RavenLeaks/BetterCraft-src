...
/* 32 */       GlStateManager.blendFunc(GlStateManager.SourceFactor.SRC_ALPHA, GlStateManager.DestFactor.ONE);
...
/* 49 */         bufferbuilder.begin(6, DefaultVertexFormats.POSITION_COLOR);
/* 50 */         bufferbuilder.pos(0.0D, 0.0D, 0.0D).color(255, 255, 255, (int)(255.0F * (1.0F - f1))).endVertex();
/* 51 */         bufferbuilder.pos(-0.866D * f3, f2, (-0.5F * f3)).color(255, 0, 255, 0).endVertex();
/* 52 */         bufferbuilder.pos(0.866D * f3, f2, (-0.5F * f3)).color(255, 0, 255, 0).endVertex();
/* 53 */         bufferbuilder.pos(0.0D, f2, (1.0F * f3)).color(255, 0, 255, 0).endVertex();
/* 54 */         bufferbuilder.pos(-0.866D * f3, f2, (-0.5F * f3)).color(255, 0, 255, 0).endVertex();
/* 55 */         tessellator.draw();
/*    */       } 
/*    */       
