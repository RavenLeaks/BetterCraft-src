...
/*  27 */       return false;
/*     */     }
/*  29 */     if (!this.theVillager.world.isDaytime())
/*     */     {
/*  31 */       return false;
/*     */     }
/*     */ 
/*     */     
/*  35 */     List<EntityIronGolem> list = this.theVillager.world.getEntitiesWithinAABB(EntityIronGolem.class, this.theVillager.getEntityBoundingBox().expand(6.0D, 2.0D, 6.0D));
/*     */     
/*  37 */     if (list.isEmpty())
/*     */     {
/*  39 */       return false;
