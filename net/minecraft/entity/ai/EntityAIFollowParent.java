...
/*     */ 
/*     */     
/*  31 */     List<EntityAnimal> list = this.childAnimal.world.getEntitiesWithinAABB(this.childAnimal.getClass(), this.childAnimal.getEntityBoundingBox().expand(8.0D, 4.0D, 8.0D));
...
/*     */         
/*  39 */         double d1 = this.childAnimal.getDistanceSqToEntity((Entity)entityanimal1);
/*     */         
/*  41 */         if (d1 <= d0) {
/*     */           
/*  43 */           d0 = d1;
...
/*     */ 
/*     */     
/*  80 */     double d0 = this.childAnimal.getDistanceSqToEntity((Entity)this.parentAnimal);
...
/* 109 */       this.childAnimal.getNavigator().tryMoveToEntityLiving((Entity)this.parentAnimal, this.moveSpeed);
/*     */     } 
/*     */   }
/*     */ }
