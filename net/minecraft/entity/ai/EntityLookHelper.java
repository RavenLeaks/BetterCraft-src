...
/*     */     
/*  40 */     if (entityIn instanceof net.minecraft.entity.EntityLivingBase) {
/*     */       
...
/*  81 */       double d3 = MathHelper.sqrt(d0 * d0 + d2 * d2);
/*  82 */       float f = (float)(MathHelper.atan2(d2, d0) * 57.29577951308232D) - 90.0F;
/*  83 */       float f1 = (float)-(MathHelper.atan2(d1, d3) * 57.29577951308232D);
...
/*     */     } 
/*     */     
/*  92 */     float f2 = MathHelper.wrapDegrees(this.entity.rotationYawHead - this.entity.renderYawOffset);
/*     */     
...
/* 110 */     float f = MathHelper.wrapDegrees(p_75652_2_ - p_75652_1_);
/*     */     
/* 112 */     if (f > p_75652_3_)
/*     */     {
/* 114 */       f = p_75652_3_;
