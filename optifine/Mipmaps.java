...
/*  24 */     this.iconName = p_i66_1_;
/*  25 */     this.width = p_i66_2_;
/*  26 */     this.height = p_i66_3_;
/*  27 */     this.data = p_i66_4_;
/*  28 */     this.direct = p_i66_5_;
/*  29 */     this.mipmapDimensions = makeMipmapDimensions(p_i66_2_, p_i66_3_, p_i66_1_);
/*  30 */     this.mipmapDatas = generateMipMapData(p_i66_4_, p_i66_2_, p_i66_3_, this.mipmapDimensions);
/*     */     
/*  32 */     if (p_i66_5_)
/*     */     {
...
/*     */       
/*  45 */       List<Dimension> list = new ArrayList();
/*  46 */       int k = i;
/*  47 */       int l = j;
/*     */ 
/*     */       
...
/*  54 */         if (k <= 0 && l <= 0) {
/*     */           
/*  56 */           Dimension[] adimension = (Dimension[])list.toArray((Object[])new Dimension[list.size()]);
...
/* Location:              C:\Users\emlin\Desktop\BetterCraft.jar!\optifine\Mipmaps.class
