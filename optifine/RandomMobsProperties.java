...
/*  20 */     this.name = connectedparser.parseName(p_i77_1_);
/*  21 */     this.basePath = connectedparser.parseBasePath(p_i77_1_);
/*  22 */     this.resourceLocations = p_i77_2_;
/*     */   }
/*     */ 
/*     */   
...
/*  28 */     this.name = connectedparser.parseName(p_i78_2_);
/*  29 */     this.basePath = connectedparser.parseBasePath(p_i78_2_);
/*  30 */     this.rules = parseRules(p_i78_1_, p_i78_3_, connectedparser);
/*     */   }
/*     */ 
/*     */   
...
/*  62 */     List<RandomMobsRule> list = new ArrayList();
...
/*  74 */         Biome[] abiome = p_parseRules_3_.parseBiomes(p_parseRules_1_.getProperty("biomes." + k));
...
/*     */         }
/*     */         
/*  82 */         RandomMobsRule randommobsrule = new RandomMobsRule(p_parseRules_2_, aint, aint1, abiome, rangelistint);
/*  83 */         list.add(randommobsrule);
/*     */       } 
/*     */     } 
/*     */     
/*  87 */     RandomMobsRule[] arandommobsrule = list.<RandomMobsRule>toArray(new RandomMobsRule[list.size()]);
...
/* Location:              C:\Users\emlin\Desktop\BetterCraft.jar!\optifine\RandomMobsProperties.class
