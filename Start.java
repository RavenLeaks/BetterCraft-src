...
/* 11 */     Main.main(concat(new String[] { "--version", "mcp", "--accessToken", "0", "--assetsDir", "assets", "--assetIndex", "1.12", "--userProperties", "{}" }, args));
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\Users\emlin\Desktop\BetterCraft.jar!\Start.class
